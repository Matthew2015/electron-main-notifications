...
class Notifier {
  ...
  showNextMessage () {
    ...
    // notificationWindow.loadURL('file://' + './public/notification.html');
    console.log('__dirname', __dirname)
    console.log('this.htmlPath', this.htmlPath)
    // notificationWindow.loadURL(path.join('file://', __dirname, '..', 'src', 'main', 'notification', 'lib', 'assets', 'notification.html'))
    notificationWindow.loadURL(path.join('file://', __dirname, '..', this.htmlPath))
